...
(function (ui) {
    var game;
    (function (game) {
        var CarItemUI = /** @class */ (function (_super) {
            __extends(CarItemUI, _super);
            function CarItemUI() {
                return _super.call(this) || this;
            }
            CarItemUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.CarItemUI.uiView);
            };
            CarItemUI.uiView = { "type": "View", "props": { "width": 126, "height": 197 }, "child": [{ "type": "Image", "props": { "y": 0, "width": 1, "skin": "ui/blackbg.png", "name": "right_up", "height": 1 } }, { "type": "Image", "props": { "width": 1, "skin": "ui/blackbg.png", "name": "right_down", "height": 1 } }, { "type": "Image", "props": { "width": 1, "skin": "ui/blackbg.png", "name": "left_up", "height": 1 } }, { "type": "Image", "props": { "width": 1, "skin": "ui/blackbg.png", "name": "left_down", "height": 1 } }, { "type": "Image", "props": { "y": 10, "x": 10, "width": 1, "skin": "ui/blackbg.png", "name": "wheel_right_up", "height": 1 } }, { "type": "Image", "props": { "y": 20, "x": 20, "width": 1, "skin": "ui/blackbg.png", "name": "wheel_right_down", "height": 1 } }, { "type": "Image", "props": { "y": 30, "x": 30, "width": 1, "skin": "ui/blackbg.png", "name": "wheel_left_up", "height": 1 } }, { "type": "Image", "props": { "y": 40, "x": 40, "width": 1, "skin": "ui/blackbg.png", "name": "wheel_left_down", "height": 1 } }, { "type": "Animation", "props": { "y": 105, "x": 37, "var": "gas_front_left", "source": "effect/TailGas1.ani", "scaleY": 0.3, "scaleX": 0.3, "rotation": 180 } }, { "type": "Animation", "props": { "y": 105, "x": 134, "var": "gas_front_right", "source": "effect/TailGas1.ani", "scaleY": 0.3, "scaleX": 0.3, "rotation": 180 } }, { "type": "Animation", "props": { "y": 189, "x": 35, "var": "gas_back_left", "source": "effect/TailGas1.ani", "scaleY": 0.3, "scaleX": 0.3, "rotation": 180 } }, { "type": "Animation", "props": { "y": 189, "x": 140, "var": "gas_back_right", "source": "effect/TailGas1.ani", "scaleY": 0.3, "scaleX": 0.3, "rotation": 180 } }, { "type": "Clip", "props": { "y": 0, "x": 0, "var": "clipCar", "skin": "car/clip_car_1.png", "clipY": 2, "clipX": 2, "anchorY": 0 } }, { "type": "Clip", "props": { "y": 89, "x": 60, "var": "clipSawLeft", "skin": "ui/clip_saw1.png", "skewY": 180, "skewX": 0, "rotation": 0, "clipY": 6, "anchorY": 0.5 } }, { "type": "Clip", "props": { "y": 89, "x": 59, "var": "clipSawRight", "skin": "ui/clip_saw1.png", "clipY": 6, "anchorY": 0.5 } }] };
            return CarItemUI;
        }(View));
        game.CarItemUI = CarItemUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var CarListItemUI = /** @class */ (function (_super) {
            __extends(CarListItemUI, _super);
            function CarListItemUI() {
                return _super.call(this) || this;
            }
            CarListItemUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.CarListItemUI.uiView);
            };
            CarListItemUI.uiView = { "type": "View", "props": { "width": 150, "height": 145 }, "child": [{ "type": "Image", "props": { "var": "imgUnlock", "skin": "car/small_car_1.png" } }, { "type": "Image", "props": { "y": 0, "x": 0, "var": "imgLock", "skin": "car/small_car_lock_1.png" } }, { "type": "Image", "props": { "y": 81, "x": 106, "var": "imgSelect", "skin": "ui/flag.png" } }] };
            return CarListItemUI;
        }(View));
        game.CarListItemUI = CarListItemUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var ContinueGameDialogUI = /** @class */ (function (_super) {
            __extends(ContinueGameDialogUI, _super);
            function ContinueGameDialogUI() {
                return _super.call(this) || this;
            }
            ContinueGameDialogUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.ContinueGameDialogUI.uiView);
            };
            ContinueGameDialogUI.uiView = { "type": "Dialog", "props": { "y": 0, "x": 0, "width": 648, "height": 1000 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "skin": "ui/board.png" } }, { "type": "Label", "props": { "y": 268, "x": 78, "width": 492, "text": "继续游戏！", "height": 88, "fontSize": 60, "font": "Microsoft YaHei", "color": "#000000", "bold": true, "align": "center" } }, { "type": "Box", "props": { "y": 363, "x": 123, "var": "boxTimeCountDown" }, "child": [{ "type": "Image", "props": { "var": "imgBottom", "skin": "ui/img_continue_round.png" } }] }, { "type": "Button", "props": { "y": 395, "x": 155, "var": "btnContinue", "stateNum": 1, "skin": "ui/btn_continue.png", "centerX": 0 } }, { "type": "Button", "props": { "y": 816, "x": 243, "var": "btnSkip", "stateNum": 1, "skin": "ui/btn_skin.png" } }] };
            return ContinueGameDialogUI;
        }(Dialog));
        game.ContinueGameDialogUI = ContinueGameDialogUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var EarnMoneyDialogUI = /** @class */ (function (_super) {
            __extends(EarnMoneyDialogUI, _super);
            function EarnMoneyDialogUI() {
                return _super.call(this) || this;
            }
            EarnMoneyDialogUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.EarnMoneyDialogUI.uiView);
            };
            EarnMoneyDialogUI.uiView = { "type": "Dialog", "props": { "width": 718, "height": 538 }, "child": [{ "type": "Image", "props": { "skin": "ui/board_2.png" } }, { "type": "Button", "props": { "y": 165, "x": 431, "width": 160, "var": "btnWatchVieo", "stateNum": 1, "skin": "ui/btn_continue.png", "height": 160 } }, { "type": "Button", "props": { "y": 165, "x": 136, "width": 160, "var": "btnShare", "stateNum": 1, "skin": "ui/btn_like.png", "height": 160 } }, { "type": "Label", "props": { "y": 347, "x": 80, "width": 264, "text": "分享获得50金币", "height": 42, "fontSize": 30, "font": "Microsoft YaHei", "color": "#0b0b0b", "bold": true, "align": "center" } }, { "type": "Label", "props": { "y": 347, "x": 367, "width": 303, "text": "观看视频获得150金币", "height": 42, "fontSize": 30, "font": "Microsoft YaHei", "color": "#0b0b0b", "bold": true, "align": "center" } }, { "type": "Button", "props": { "y": 64, "x": 628, "var": "btnClose", "stateNum": 1, "skin": "ui/btn_close.png", "scaleY": 1.4, "scaleX": 1.4 } }] };
            return EarnMoneyDialogUI;
        }(Dialog));
        game.EarnMoneyDialogUI = EarnMoneyDialogUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var ExhibitionCarItemUI = /** @class */ (function (_super) {
            __extends(ExhibitionCarItemUI, _super);
            function ExhibitionCarItemUI() {
                return _super.call(this) || this;
            }
            ExhibitionCarItemUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.ExhibitionCarItemUI.uiView);
            };
            ExhibitionCarItemUI.uiView = { "type": "View", "props": { "width": 340, "height": 380 }, "child": [{ "type": "Image", "props": { "y": 188, "x": 171, "var": "imgCar", "skin": "car/car3_lock.png", "scaleY": 1.5, "scaleX": 1.5, "rotation": 0, "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Clip", "props": { "y": 188, "x": 171, "var": "clipCar", "skin": "car/clip_car_3.png", "scaleY": 1.8, "scaleX": 1.8, "clipY": 2, "clipX": 2, "anchorY": 0.5, "anchorX": 0.5 } }] };
            return ExhibitionCarItemUI;
        }(View));
        game.ExhibitionCarItemUI = ExhibitionCarItemUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var ExhibitionSkillItemUI = /** @class */ (function (_super) {
            __extends(ExhibitionSkillItemUI, _super);
            function ExhibitionSkillItemUI() {
                return _super.call(this) || this;
            }
            ExhibitionSkillItemUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.ExhibitionSkillItemUI.uiView);
            };
            ExhibitionSkillItemUI.uiView = { "type": "View", "props": { "width": 300, "height": 300 }, "child": [{ "type": "Image", "props": { "y": 150, "x": 150, "width": 300, "var": "imgUnlock", "skin": "ui/more_arrows.png", "height": 300, "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Image", "props": { "y": 150, "x": 150, "width": 300, "var": "imgLock", "skin": "ui/more_arrows_lock.png", "height": 300, "anchorY": 0.5, "anchorX": 0.5 } }] };
            return ExhibitionSkillItemUI;
        }(View));
        game.ExhibitionSkillItemUI = ExhibitionSkillItemUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var GameOverDialogUI = /** @class */ (function (_super) {
            __extends(GameOverDialogUI, _super);
            function GameOverDialogUI() {
                return _super.call(this) || this;
            }
            GameOverDialogUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.GameOverDialogUI.uiView);
            };
            GameOverDialogUI.uiView = { "type": "Dialog", "props": { "y": 0, "x": 0, "width": 648, "height": 1000 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "skin": "ui/board.png", "centerY": 0, "centerX": 0 } }, { "type": "Button", "props": { "y": 693, "x": 188, "var": "btnDoubleScore", "stateNum": 1, "skin": "ui/btn_double_score.png", "centerX": 0 } }, { "type": "Box", "props": { "y": 811, "x": 111, "centerX": 0 }, "child": [{ "type": "Button", "props": { "y": 0, "x": 0, "var": "btnCarShop", "stateNum": 1, "skin": "ui/btn_car_shop.png" } }] }, { "type": "Button", "props": { "y": 508, "var": "btnPlay", "stateNum": 1, "skin": "ui/btn_play_circle.png", "centerX": 0 } }, { "type": "Label", "props": { "y": 241, "x": 159, "width": 321, "var": "tfMonsterScore", "text": "32", "height": 115, "fontSize": 90, "font": "Microsoft YaHei", "color": "#000000", "centerX": 0, "bold": true, "align": "center" } }, { "type": "Image", "props": { "y": 233, "x": 462, "skin": "ui/zombie_score.png", "scaleY": 0.3, "scaleX": 0.3 } }, { "type": "Label", "props": { "y": 385, "x": 159, "width": 321, "var": "tfTimeScore", "text": "32", "height": 115, "fontSize": 90, "font": "Microsoft YaHei", "color": "#000000", "centerX": -5, "bold": true, "align": "center" } }, { "type": "Image", "props": { "y": 379, "x": 454, "skin": "ui/img_time.png" } }] };
            return GameOverDialogUI;
        }(Dialog));
        game.GameOverDialogUI = GameOverDialogUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
    (function (game) {
        var GameSkillModuleUI = /** @class */ (function (_super) {
            __extends(GameSkillModuleUI, _super);
            function GameSkillModuleUI() {
                return _super.call(this) || this;
            }
            GameSkillModuleUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.GameSkillModuleUI.uiView);
            };
            GameSkillModuleUI.uiView = { "type": "View", "props": { "width": 133, "height": 127 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "skin": "ui/bonus.png", "scaleY": 1.5, "scaleX": 1.5 } }, { "type": "Image", "props": { "y": 58, "x": 73, "var": "imgSkill", "skin": "ui/more_arrows.png", "scaleY": 0.2, "scaleX": 0.2, "anchorY": 0.5, "anchorX": 0.5 }, "compId": 4 }, { "type": "Image", "props": { "y": 18, "x": 40, "width": 64, "var": "imgSkillShade", "skin": "ui/img_skill_shade.png", "height": 79 } }], "animations": [{ "nodes": [{ "target": 4, "keyframes": { "alpha": [{ "value": 1, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "alpha", "index": 0 }, { "value": 0.5, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "alpha", "index": 20 }] } }], "name": "ani1", "id": 1, "frameRate": 24, "action": 0 }] };
            return GameSkillModuleUI;
        }(View));
        game.GameSkillModuleUI = GameSkillModuleUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
...
(function (ui) {
    var game;
    (function (game) {
        var SkillListItemUI = /** @class */ (function (_super) {
            __extends(SkillListItemUI, _super);
            function SkillListItemUI() {
                return _super.call(this) || this;
            }
            SkillListItemUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(ui.game.SkillListItemUI.uiView);
            };
            SkillListItemUI.uiView = { "type": "View", "props": { "width": 136, "height": 136 }, "child": [{ "type": "Image", "props": { "var": "imgUnlock", "skin": "ui/small_hourglass.png" } }, { "type": "Image", "props": { "var": "imgLock", "skin": "ui/small_hourglass_lock.png" } }] };
            return SkillListItemUI;
        }(View));
        game.SkillListItemUI = SkillListItemUI;
    })(game = ui.game || (ui.game = {}));
})(ui || (ui = {}));
(function (ui) {
    var game;
