var Main = /** @class */ (function () {
    function Main() {
        ...
        var showWidth = Math.floor(Laya.Browser.width / (Laya.Browser.height / 1334));
        ...
        Laya.loader.load([{ url: module.ResRoadConfigData.URL, type: laya.net.Loader.JSON },
            ...
            { url: module.ResRoadProbilityData.URL, type: laya.net.Loader.JSON }], Laya.Handler.create(this, this.onLoadResourceComplete));
    }
    Main.prototype.onLoadResourceComplete = function () {
